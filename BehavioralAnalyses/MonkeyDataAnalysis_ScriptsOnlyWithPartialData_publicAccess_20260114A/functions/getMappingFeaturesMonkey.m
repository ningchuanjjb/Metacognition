function features = getMappingFeaturesMonkey(sequence, isCorrect)
%features = [seqOnehot seq_length_trial numChunk_trial rightOffset_trial ifSymmetry_trial seq_range_trial isCorrect];    

numFrames_rangeTail = 6;
