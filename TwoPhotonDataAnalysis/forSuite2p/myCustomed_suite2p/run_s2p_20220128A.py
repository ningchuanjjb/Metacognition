...
def run_s2p(ops={}, db={}, server={}):
    ...
    #print(db) hide redundant info here
    ...
    if len(plane_folders) > 0:
        #for tempi in range(0,len(plane_folders)):
        #    plane_folders[tempi] = plane_folders[tempi].replace('\\','/')
        #    print('-----------------------plane_folders=%s \n' %(plane_folders[tempi]))
        ...
        #print('-----------------------binaries_found_flag=%d \n' %(binaries_found_flag))

        #a = os.path.isfile('C:/ASDROOT/STUDY/twoPhotonData/113Recording_Bubble_20221211A_fixZtest/test4/suite2p/plane0/data.bin')
        #print('-----------------------a=%d \n' %(a))
        #b = os.path.isfile('C:/ASDROOT/STUDY/twoPhotonData/113Recording_Bubble_20221211A_fixZtest/test4/suite2p/plane0/data.bin')
        #print('-----------------------b=%d \n' %(b))        
    else:
        files_found_flag = False

    #print('-----------------------plane_folders=%d \n' %(len(plane_folders)))
    #print('-----------------------plane_folders=%s \n' %(plane_folders[0]))
