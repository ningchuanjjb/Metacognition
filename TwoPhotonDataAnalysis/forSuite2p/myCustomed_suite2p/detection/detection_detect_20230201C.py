...
def select_rois(ops: Dict[str, Any], mov: np.ndarray, 
	...
	if sparse_mode:
		...
		#print('select_rois, asd2')
		#while True:
		#	a = 1

		print('Initial threshold_scaling = %.3f.\n' %(ops['threshold_scaling']),end="")
