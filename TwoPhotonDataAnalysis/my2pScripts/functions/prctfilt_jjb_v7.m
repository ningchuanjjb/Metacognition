function Y = prctfilt_jjb_v6(X,p,window,shift,mode)
...
temp1 = (1:window)';
temp2 = repmat(temp1,1,ln) + blocks_start - 1;
Xpad_multi = Xpad(temp2);
Xpcs = prctile(Xpad_multi,p,1);
% Xpcs = prctile(Xpad_multi,p,1,'Method','approximate');
% Xpcs = prctile(Xpad_multi,p,1,'Method','exact');
