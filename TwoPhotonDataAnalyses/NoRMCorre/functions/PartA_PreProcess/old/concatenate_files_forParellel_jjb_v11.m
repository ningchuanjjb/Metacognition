function [Ycon,ln,error_flag] = concatenate_files_forParellel_jjb_v11(files,fileName,output_type)
...
if output_type_flag_h50_bin1 == 0
    for i = 1:numFiles     
        ...
        for tempj=1:batchNum
            ...
            current_step = temp_lnijRange(tempj,2) - temp_lnijRange(tempj,1);
