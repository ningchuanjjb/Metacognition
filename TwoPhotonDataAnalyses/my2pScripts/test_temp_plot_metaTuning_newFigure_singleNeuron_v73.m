...
loadExampleNeuronID_demo = 4;%3 or 4;3 for Figure 1I, 4 for Figure 5D.

if if_loadDemoData == 1
    if loadExampleNeuronID_demo == 3
        temp_F_dff_exampleNeuron_metaX = decodingDataSimplified.F_dff_exampleNeuron_meta3;
    elseif loadExampleNeuronID_demo == 4
        temp_F_dff_exampleNeuron_metaX = decodingDataSimplified.F_dff_exampleNeuron_meta4;
    end
end
...
if if_loadDemoData == 1
    if loadExampleNeuronID_demo == 3
        if_plot_multiPanelD2 = 1;
        if_plot_multiPanelC = 0;
        if_halfTrial = 0;
    elseif loadExampleNeuronID_demo == 4
        if_plot_multiPanelD2 = 0;
        if_plot_multiPanelC = 1;
        if_halfTrial = 1;
    end
end
...
elseif if_loadDemoData == 1
    cellID_F_dff_baselinePeriod_choiceMemory = temp_F_dff_exampleNeuron_metaX.cellID_F_dff_baselinePeriod_choiceMemory;
    cellID_F_dff_baselinePeriod_choiceOffload = temp_F_dff_exampleNeuron_metaX.cellID_F_dff_baselinePeriod_choiceOffload;    
end
...
elseif if_loadDemoData == 1
    cellID_F_dff_length1_sample = temp_F_dff_exampleNeuron_metaX.cellID_F_dff_length1_sample;
    cellID_F_dff_length2_sample = temp_F_dff_exampleNeuron_metaX.cellID_F_dff_length2_sample;
    cellID_F_dff_length3_sample = temp_F_dff_exampleNeuron_metaX.cellID_F_dff_length3_sample;
end
...
elseif if_loadDemoData == 1
    cellID_F_dff_decisionPeriodA_choiceMemory = temp_F_dff_exampleNeuron_metaX.cellID_F_dff_decisionPeriodA_choiceMemory;
    cellID_F_dff_decisionPeriodA_choiceOffload = temp_F_dff_exampleNeuron_metaX.cellID_F_dff_decisionPeriodA_choiceOffload;
end
...
elseif if_loadDemoData == 1
    cellID_F_dff_decisionPeriod_choiceMemory = temp_F_dff_exampleNeuron_metaX.cellID_F_dff_decisionPeriod_choiceMemory;
    cellID_F_dff_decisionPeriod_choiceOffload = temp_F_dff_exampleNeuron_metaX.cellID_F_dff_decisionPeriod_choiceOffload;
end
...
elseif if_loadDemoData == 1    
    cellID_F_dff_baselinePeriod_sortedSeq_collaped = temp_F_dff_exampleNeuron_metaX.cellID_F_dff_baselinePeriod_sortedSeq_collaped;
end
...
elseif if_loadDemoData == 1
    cellID_F_dff_decisionPeriodA_sortedSeq_collaped = temp_F_dff_exampleNeuron_metaX.cellID_F_dff_decisionPeriodA_sortedSeq_collaped;
end
...
elseif if_loadDemoData == 1
    cellID_F_dff_decisionPeriod_sortedSeq_collaped = temp_F_dff_exampleNeuron_metaX.cellID_F_dff_decisionPeriod_sortedSeq_collaped;
end
...
%         max_baselineDecisionPeriod = max_baselineDecisionPeriod_raw+(max_baselineDecisionPeriod_raw-min_baselineDecisionPeriod_raw)*0.1;
    ...
    if if_plot_multiPanelC == 1
        ...
        tempPlotIndicator = 0;%0 for small, 1 for big, 2 for smaller
...
if false
    ...
    temp_F_dff_exampleNeuron_metaX = struct; %#ok<*UNRCH>
    temp_F_dff_exampleNeuron_metaX.cellID_F_dff_baselinePeriod_sortedSeq_collaped = cellID_F_dff_baselinePeriod_sortedSeq_collaped;
    temp_F_dff_exampleNeuron_metaX.cellID_F_dff_decisionPeriodA_sortedSeq_collaped = cellID_F_dff_decisionPeriodA_sortedSeq_collaped;
    temp_F_dff_exampleNeuron_metaX.cellID_F_dff_decisionPeriod_sortedSeq_collaped = cellID_F_dff_decisionPeriod_sortedSeq_collaped;
    
    temp_F_dff_exampleNeuron_metaX.cellID_F_dff_baselinePeriod_choiceMemory = cellID_F_dff_baselinePeriod_choiceMemory;
    temp_F_dff_exampleNeuron_metaX.cellID_F_dff_baselinePeriod_choiceOffload = cellID_F_dff_baselinePeriod_choiceOffload;
    temp_F_dff_exampleNeuron_metaX.cellID_F_dff_decisionPeriodA_choiceMemory = cellID_F_dff_decisionPeriodA_choiceMemory;
    temp_F_dff_exampleNeuron_metaX.cellID_F_dff_decisionPeriodA_choiceOffload = cellID_F_dff_decisionPeriodA_choiceOffload;
    
    temp_F_dff_exampleNeuron_metaX.cellID_F_dff_length1_sample = cellID_F_dff_length1_sample;
    temp_F_dff_exampleNeuron_metaX.cellID_F_dff_length2_sample = cellID_F_dff_length2_sample;
    temp_F_dff_exampleNeuron_metaX.cellID_F_dff_length3_sample = cellID_F_dff_length3_sample;
    
    temp_F_dff_exampleNeuron_metaX.cellID_F_dff_decisionPeriod_choiceMemory = cellID_F_dff_decisionPeriod_choiceMemory;
    temp_F_dff_exampleNeuron_metaX.cellID_F_dff_decisionPeriod_choiceOffload = cellID_F_dff_decisionPeriod_choiceOffload;
    
    %F_dff_exampleNeuron_meta3 = temp_F_dff_exampleNeuron_metaX;
    %decodingDataSimplified.F_dff_exampleNeuron_meta3 = F_dff_exampleNeuron_meta3;
    
    F_dff_exampleNeuron_meta4 = temp_F_dff_exampleNeuron_metaX;
    decodingDataSimplified.F_dff_exampleNeuron_meta4 = F_dff_exampleNeuron_meta4;
