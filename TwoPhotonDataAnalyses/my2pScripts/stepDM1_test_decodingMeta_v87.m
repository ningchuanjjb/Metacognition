% Chuan's 10th script (20251214)
% This script: To train and test meta-memory decoder, related to figure 3.

% please run 'stepF4A_memoryMetaMismatch_singleNeuron.m' first

% delay meta-WM decoder: let if_trainMeta_0baseline_1delay1 = 1
% baseline meta-WM decoder: let if_trainMeta_0baseline_1delay1 = 0
...
if if_loadDemoData == 1
    ...
    demoData_dirPath = 'C:\ASDROOT\STUDY\TwoPhotonDataAnalysis\my2pScripts\demoData';
    
    demoData_fullPath = [demoData_dirPath,'\','demoData.mat'];
end


%% Initialization & Params setting
...
if exist('if_trainMeta_0baseline_1delay1','var') == 0 
    if_trainMeta_0baseline_1delay1 = 1;
end
...
elseif if_loadDemoData == 1
    temp_load = load(demoData_fullPath,'decodingDataSimplified');
    decodingDataSimplified = temp_load.decodingDataSimplified;
end
...
if if_loadDemoData == 1
    path_behavior = demoData_dirPath;
end
...
if exist('if_memeoryPrecision_stimuli0_response1','var') == 0
    if_memeoryPrecision_stimuli0_response1 = 0;
end
...
elseif if_loadDemoData == 1
    neuronBoolIndex = true(size(F_dff_decisionBin_demo,1),1);
end
...
if if_dff_singleSession1_twoSession2_allSession3 < 3
    ...
    elseif if_trainMeta_0baseline_1delay1 == 0
        ...
        elseif if_loadDemoData == 1
            F_dff_decisionBin1 = F_dff_baselineBin_demo;
        end
    end
        ...
        elseif if_trainMeta_0baseline_1delay1 == 0
            ...
            elseif if_monkey_D0_Z1 == 1
                ...
                if currentSessionIndex_AB == 9
                    AUROC_shuffled_prctile = 0.530;% FOV9
                elseif currentSessionIndex_AB == 13
                    AUROC_shuffled_prctile = 0.539;% FOV13
                end
            end            
        end
