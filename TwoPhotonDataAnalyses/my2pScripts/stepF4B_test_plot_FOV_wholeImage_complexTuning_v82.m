...
if_trialTuning0_seqTuning1_mix2 = if_plotBeta_trialTuning0_seqTuning1_mix2;%2,if_plotBeta_trialTuning0_seqTuning1_mix2
...
threshold_prctileB = 100-threshold_prctileA;%95-->99.9-->100-threshold_prctileA


threshold_prctile_clusterA = 95;%95

threshold_prctile_clusterB_high = 95;%95,99,95
threshold_prctile_clusterB_low = 100-threshold_prctile_clusterB_high;%100-threshold_prctile_clusterB_high
...
if_plot_twoFeatureMerge = 0;%0
if_plot_contour0_r2Circle1 = 1;%1

if_plot_twoFeatureSplit = 0;%0
if_plot_twoFeatureSplitB = 1;%1

if_plot_centriodComparison = 0;%0

if_plot_clusterA = 0;%0
...
if_r2_binary = 1;%1
if_r2Binary_unitView0_subspaceView1 = 0;%0,1,0
...
% load template and roi_stats of current FOV
if if_loadDemoData == 0
...
elseif if_loadDemoData == 1
    template_path = [demoData_dirPath,'\','maxProjection_demo.tif'];
    template = double(loadtiff(template_path));
    
    fullFileName_Fall = [demoData_dirPath,'\','roi_stats_demo.mat'];    
    s = load(fullFileName_Fall);
    roi_stats = s.roi_stats;
end
