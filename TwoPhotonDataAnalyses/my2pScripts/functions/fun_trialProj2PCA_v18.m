function [F_dff_PCA,designMatrix_allSDT_multiFOV,r2Valid_boolIndex_inOne]=...
    fun_trialProj2PCA_v18(if_glm_12B0_24B1_6B2,r2Valid_boolIndex_inOne)
%% Initialization
...
F_dff_PCA_lengthx_delay1Bin_multiFOV = [];
F_dff_PCA_lengthx_delay2Bin_multiFOV = [];
F_dff_PCA_lengthx_baselineBin_multiFOV = [];

designMatrix_allSDT_multiFOV = [];
...
num_roi_singelFOV = zeros(fileSize,1);
num_trial_singelFOV = zeros(fileSize,1);
...
for tempIndex=1:fileSize
    ...
    F_dff_lengthx_baselineBin; %#ok<*VUNUS>
    ...
    F_dff_PCA_lengthx_baselineBin = [];
    F_dff_PCA_lengthx_delay1Bin = [];
    F_dff_PCA_lengthx_delay2Bin = [];
    
    a = 1;
    
    num_roi;
    [temp_num_roi,temp_num_trial] = size(F_dff_lengthx_baselineBin);
    num_roi_singelFOV(tempIndex) = temp_num_roi;
    num_trial_singelFOV(tempIndex) = temp_num_trial;
    
    temp_range1_roi = [sum(num_roi_singelFOV(1:(tempIndex-1)))+1, sum(num_roi_singelFOV(1:tempIndex))];
    temp_range2_roi = temp_range1_roi(1):temp_range1_roi(2);
    
    a = 1;
    
    F_dff_lengthx_baselineBin_extend = zeros(num_roi,temp_num_trial);
    F_dff_lengthx_delay1Bin_extend = zeros(num_roi,temp_num_trial);
    F_dff_lengthx_delay2Bin_extend = zeros(num_roi,temp_num_trial);
    
    a = 1;
    
    
    %F_dff_lengthx_baselineBin_extend(temp_range2_roi,:) = F_dff_lengthx_baselineBin;
    %F_dff_lengthx_delay1Bin_extend(temp_range2_roi,:) = F_dff_lengthx_delay1Bin;
    %F_dff_lengthx_delay2Bin_extend(temp_range2_roi,:) = F_dff_lengthx_delay2Bin;
    F_dff_lengthx_baselineBin_extend(temp_range2_roi,:) = F_dff_lengthx_baselineBin_zscore;
    F_dff_lengthx_delay1Bin_extend(temp_range2_roi,:) = F_dff_lengthx_delay1Bin_zscore;
    F_dff_lengthx_delay2Bin_extend(temp_range2_roi,:) = F_dff_lengthx_delay2Bin_zscore;
    
    a = 1;
    
    pca_coeff;
    r2Valid_boolIndex_inOne;
    
    % Time-consuming!
    F_dff_PCA_lengthx_baselineBin = pca_coeff{1}' * F_dff_lengthx_baselineBin_extend(r2Valid_boolIndex_inOne,:);
    F_dff_PCA_lengthx_delay1Bin = pca_coeff{2}' * F_dff_lengthx_delay1Bin_extend(r2Valid_boolIndex_inOne,:);
    F_dff_PCA_lengthx_delay2Bin = pca_coeff{3}' * F_dff_lengthx_delay2Bin_extend(r2Valid_boolIndex_inOne,:);
    
    a = 1;
    
    
    F_dff_PCA_lengthx_baselineBin_multiFOV = [F_dff_PCA_lengthx_baselineBin_multiFOV, F_dff_PCA_lengthx_baselineBin]; %#ok<*AGROW>
    F_dff_PCA_lengthx_delay1Bin_multiFOV = [F_dff_PCA_lengthx_delay1Bin_multiFOV, F_dff_PCA_lengthx_delay1Bin];
    F_dff_PCA_lengthx_delay2Bin_multiFOV = [F_dff_PCA_lengthx_delay2Bin_multiFOV, F_dff_PCA_lengthx_delay2Bin];
    
    designMatrix_allSDT_multiFOV = [designMatrix_allSDT_multiFOV; designMatrix_allSDT];
...
F_dff_PCA = struct;
F_dff_PCA.F_dff_PCA_lengthx_baselineBin_multiFOV = F_dff_PCA_lengthx_baselineBin_multiFOV;
F_dff_PCA.F_dff_PCA_lengthx_delay1Bin_multiFOV = F_dff_PCA_lengthx_delay1Bin_multiFOV;
F_dff_PCA.F_dff_PCA_lengthx_delay2Bin_multiFOV = F_dff_PCA_lengthx_delay2Bin_multiFOV;
