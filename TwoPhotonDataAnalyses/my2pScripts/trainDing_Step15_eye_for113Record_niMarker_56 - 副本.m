...
[fixWinSize_delay2, basic_para.fixWinSize_delay2] = deal(225);%%400-->187-->193-->225
...
elseif if_221False_329True == 1
    [initGiveWaterTime, basic_para.initGiveWaterTime] = deal(218);
...
[InternalMemoryWaterRatio, basic_para.InternalMemoryWaterRatio] = deal(1.4);%1.5-->1.4-->1.32-->1.22-->1.3-->1.4
...
if ifSpecializedTraining_G == 1
    ...
    [probFreeTouch, basic_para.probFreeTouch] = deal(1);%0.8, 0
