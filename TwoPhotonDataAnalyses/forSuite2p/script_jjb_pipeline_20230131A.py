...
#import forSuite2p.mydefault_ops
...
ops = mydefault_ops() # populates ops with the default options

ops['threshold_scaling'] = 0.52 # 1.5-->0.75-->0.70-->0.52-->0.45
