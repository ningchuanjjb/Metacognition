def default_ops():
    ...
    print('This is my default ops')
    
    return {
        'suite2p_version': '0.11.1',
        ...
        'fs': 30.0,  # sampling rate (PER PLANE e.g. for 12 plane recordings it will be around 2.5), 15.0 --> 30.0
        ...
        'save_mat': True,  # whether to save output as matlab files, False --> True
        'save_NWB': False,  # whether to save output as NWB file
        'combined': True,  # combine multiple planes into a single result /single canvas for GUI
        'aspect': 1,  # um/pixels in X / um/pixels in Y (for correct aspect ratio in GUI), 1.0 --> 1.3671875 --> 1
        ...
        'spatial_scale': 2,  # 0: multi-scale; 1: 6 pixels, 2: 12 pixels, 3: 24 pixels, 4: 48 pixels, 0-->2
        'connected': True,  # whether or not to keep ROIs fully connected (set to 0 for dendrites)
        'nbinned': 10000,  # max number of binned frames for cell detection, 5000-->10000
        'max_iterations': 40,  # maximum number of iterations to do cell detection, 20-->40
        'threshold_scaling': 1.5,  # adjust the automatically determined threshold by this scalar multiplier, 1.0 --> 1.5
