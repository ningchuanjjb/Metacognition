            ...
            for key in keys:
                ...
                while 1:
                    ...
                    for j in range(0,nplanes):
                        ...
                        #reg_file[j].write(bytearray(im2write)) # To break the while loop ASAP so that saving time from converting to binary
                    ...
                    break # To break the while loop ASAP so that saving time from converting to binary
