...
ops['max_iterations'] = 6 # maximum number of iterations to do cell detection 20-->40-->20
ops['batch_size'] = 500 # 500-->1500-->500
ops['circular_neuropil'] = True # to enable circular extend of neuropil duration neuropil search
ops['active_percentile'] = 95 # to search roi by a percentile based-on distribution, instead of a fixed parameter
